    ...
    public static class ConsoleHelper
    {
        ...
        public static double CalculateStandardDeviation (IEnumerable<double> values)
        {
            ...
            double sumOfSquaresOfDifferences = values
                ...
                .Sum();
            return (double)Math.Sqrt(sumOfSquaresOfDifferences / (values.Count()-1));
        }

        public static double CalculateConfidenceInterval95(IEnumerable<double> values) => (double)(1.96 * CalculateStandardDeviation(values) / Math.Sqrt(values.Count() - 1));
        ...
        public static void ShowDataViewInConsole(
            MLContext mlContext,
            IDataView dataView,
            int numberOfRows = 4)
        {
