...
class BoltzmannBrainNN:
    def __init__(self, input_size, hidden_size, output_size, forehead_temperature=37.0, natural_unit=1.0):
    ...
    def boltzmann_distribution(self, x):
        exp_x = np.exp(-x / (self.temperature * self.natural_unit))
...
bbnn = BoltzmannBrainNN(input_size=3, hidden_size=5, output_size=2, forehead_temperature=37.0, natural_unit=1.0)
