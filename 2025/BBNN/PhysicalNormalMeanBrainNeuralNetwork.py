...
class PhysicalNormalMeanBrainNeuralNetwork:
    ...
    def sample_activation(self, x):
        prob = self.normal_distribution(x)
...
bbnn = PhysicalNormalMeanBrainNeuralNetwork(input_size=3, hidden_size=5, output_size=2, forehead_temperature=310.15, natural_unit=1.0, boltzmann_constant=1.38e-23)
